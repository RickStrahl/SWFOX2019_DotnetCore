...
EXE_FILE		  =		  	"Southwestfoxdemo"
DCOM_ProgId       =			"Southwestfoxdemo.SouthwestfoxdemoServer"
DCOM_UserId		  =			"Interactive User"

*** Server Update Urls - fix these to point at your production Server/Virtual
HTTP_UPLOADURL    =         "http://localhost/Southwestfoxdemo/UploadExe.wc"
HTTP_UPDATEURL 	  =         "http://localhost/Southwestfoxdemo/UpdateExe.wc"

*** for ISAPI use this url
* HTTP_UPLOADURL    =         "http://localhost/Southwestfoxdemo/wc.wc?wwmaint~FileUpload"
